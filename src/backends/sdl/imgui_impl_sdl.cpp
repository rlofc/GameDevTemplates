...
{
    ImGuiIO& io = ImGui::GetIO();
    io.KeyMap[ImGuiKey_Tab] = SDLK_TAB;  // Keyboard mapping. ImGui will use those indices to
    ...
    io.RenderDrawListsFn = ImGui_ImplSdl_RenderDrawLists;  // Alternatively you can set this to
...
void ImGui_ImplSdl_NewFrame(SDL_Window* window)
{
    ...
    if (SDL_GetWindowFlags(window) & SDL_WINDOW_MOUSE_FOCUS)
        io.MousePos = ImVec2((float)mx, (float)my);  // Mouse position, in pixels (set to -1,-1
